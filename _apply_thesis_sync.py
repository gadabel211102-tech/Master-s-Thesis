...
src = Path('/mnt/c/Users/gadab/Desktop/OneDrive - Uppsala universitet/MyThesis.docx')
backup = Path('/mnt/c/Users/gadab/Desktop/OneDrive - Uppsala universitet/MyThesis.pre_annotation_genotype_sync_2026-04-09.docx')
...
with ZipFile(src) as zin:
    ...
    for p in root.findall('.//w:p', ns):
        ...
        if full in replacements:
            ...
            changed += 1
    if changed != 3:
        raise RuntimeError(f'Expected 3 paragraph replacements, got {changed}')
