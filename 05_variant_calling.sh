...
# ------------------------------------------------------------------------------------
# Script 05: Targeted Variant Calling Pipeline
# ------------------------------------------------------------------------------------
# Purpose:
#   Run the primary variant-calling workflow for the targeted sequencing panel.
#   Each sample progresses through Torrent Variant Caller output, VCF
#   normalisation, quality filtering and export to the standard project layout.
#
# Inputs:
#   - A manifest listing BAM files to analyse.
#   - Reference FASTA, target BED file and optional hotspot/TVC resources.
#
# Outputs:
#   - Filtered per-sample VCF files and execution logs in the output directory.
#
# Methodological note:
#   This script is deliberately operational rather than statistical: its role is
#   to generate a reproducible, quality-filtered call set that later scripts
#   annotate, summarise and compare biologically.
# ------------------------------------------------------------------------------------
